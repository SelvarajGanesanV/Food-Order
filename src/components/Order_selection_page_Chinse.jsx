...
import header from '../redux/Assests/header.jpg';
...
const Order_selection_page_Chinse = () => {

    const Page_count = [1, 2, 3, 4, 5];

    const [Page_number, setPage_number] = useState(0);

    const Chinse_Order = useSelector((state) => state.allProducts.Order.chinse[Page_number]);

    const Recepies = [Chinse_Order];
...
export default Order_selection_page_Chinse;